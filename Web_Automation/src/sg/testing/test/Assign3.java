...
public class Assign3 {
	...
	public static void main(String[] args) {
		...
		customerusertest.launchBrowser();
		customerusertest.navigate();
		customerusertest.minimizeFlyOutWindow();
		customerusertest.login();
		customerusertest.createcustomer();
		
		customerusertest.delete();
		customerusertest.logout();
